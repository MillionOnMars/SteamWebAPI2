...
{
    public class SteamPartnerInterfaceFactory : ISteamWebInterfaceFactory
    {
        private readonly string steamWebApiBaseUrl = "https://partner.steam-api.com/";
        ...
        public SteamPartnerInterfaceFactory(string steamWebApiKey) 
        ...
        public SteamPartnerInterfaceFactory(IOptions<SteamWebInterfaceFactoryOptions> options)
        {
            if (options == null)
            {
            ...
            var mapperConfig = new MapperConfiguration(config =>
            {
                ...
                */
                config.AddProfile<SteamPartnerProfile>();
            });
